...
- `harness-alchemist.json` is the explicit adaptation boundary for existing monorepos. Keep generated projects strict by default; adapted `pluginRoot` packages still satisfy the same skill, manifest, runtime, and npm-payload contracts.
